...
public void kosong(){
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Jenis", "Keterangan", "Harga", "Tanggal", "Bulan"
            }
        ));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(66, 273, 572, 160));

        jLabel3.setFont(new java.awt.Font("Segoe UI Semibold", 0, 30)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 153, 153));
        jLabel3.setText("Data Pengeluaran");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(227, 35, -1, -1));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, -1, 76));

        jLabel5.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel5.setText("Harga");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 174, 46, -1));
        ...
        jPanel1.add(txtjenis, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 100, 170, -1));

        txharga.setForeground(new java.awt.Color(51, 51, 51));
        jPanel1.add(txharga, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 169, 170, -1));
        jPanel1.add(txtketerangan, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 135, 170, -1));

        jLabel10.setBackground(new java.awt.Color(0, 0, 0));
        jLabel10.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel10.setText("Jenis");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 105, -1, -1));

        cmbulan.setBackground(new java.awt.Color(0, 102, 102));
        cmbulan.setMaximumRowCount(13);
        cmbulan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "JANUARY", "FEBRUARY", "MARCH", "APRIL", "MAY", "JUNE", "JULY", "AUGUST", "SEPTEMBER", "OCTOBER", "NOVEMBER", "DECEMBER" }));
        cmbulan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbulanActionPerformed(evt);
            }
        });
        jPanel1.add(cmbulan, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 241, 96, -1));
        ...
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 420, 190, -1));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 421, -1, -1));
        ...
        jPanel1.add(txtotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(329, 451, 130, -1));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 110, 76));
        ...
        jPanel1.add(txtanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 205, 170, -1));

        jLabel11.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel11.setText("Tanggal");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 210, 74, -1));
        ...
        jPanel1.add(btncari, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 100, 37, 30));
        ...
        jPanel1.add(txtcari, new org.netbeans.lib.awtextra.AbsoluteConstraints(457, 101, 120, -1));
        ...
        jPanel1.add(Jlabelll1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, -1, 40));
        ...
        jPanel1.add(Jlabelll2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 180, 80, 40));
        ...
        jPanel1.add(Jlabelll3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 220, 80, 40));

        jLabel18.setBackground(new java.awt.Color(0, 0, 0));
        jLabel18.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel18.setText("Cari Data");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(378, 106, -1, -1));

        jLabel19.setBackground(new java.awt.Color(0, 0, 0));
        jLabel19.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        jLabel19.setText("Total Pengeluaran");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(198, 454, -1, -1));

        Jlabelll4.setFont(new java.awt.Font("Futura Bk BT", 0, 18)); // NOI18N
        Jlabelll4.setForeground(new java.awt.Color(255, 255, 255));
        Jlabelll4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/print1.png"))); // NOI18N
        Jlabelll4.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll4MouseClicked(evt);
            }
        });
        jPanel1.add(Jlabelll4, new org.netbeans.lib.awtextra.AbsoluteConstraints(558, 230, 80, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(265, 0, 690, 500));
    ...
    DefaultTableModel tblModel = (DefaultTableModel) jTable1.getModel();
        String tbljenis = tblModel.getValueAt(jTable1.getSelectedRow(), 0).toString();
        String tblketerangan = tblModel.getValueAt(jTable1.getSelectedRow(), 1).toString();
        String tblharga = tblModel.getValueAt(jTable1.getSelectedRow(), 2).toString();
        String tbltanggal = tblModel.getValueAt(jTable1.getSelectedRow(), 3).toString();
        String tblbulan = tblModel.getValueAt(jTable1.getSelectedRow(), 3).toString();
        
        txtjenis.setText(tbljenis);
        txtketerangan.setText(tblketerangan);
        txharga.setText(tblharga);
        txtanggal.setText(tbltanggal);
        cmbulan.setSelectedItem(tblbulan);
    ...
    private void cmbulanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbulanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cmbulanActionPerformed
...
try {
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        String sql = "UPDATE pengeluaran "
                + "SET jenis = ?, harga = ?, tanggal = ?, bulan = ? "
                + "WHERE keterangan = ?";

        java.sql.Connection conn = (java.sql.Connection) Config.getConnection();
        java.sql.PreparedStatement pst = conn.prepareStatement(sql);

        pst.setString(1, txtjenis.getText());
        pst.setString(2, txharga.getText());
        pst.setString(3, txtanggal.getText());
        pst.setString(4, cmbulan.getSelectedItem().toString());
        ...
        if (rowsAffected > 0) {
            ...
            if (selectedRow != -1) {
                jTable1.setValueAt(txtjenis.getText(), selectedRow, 1);
                jTable1.setValueAt(txharga.getText(), selectedRow, 2);
                jTable1.setValueAt(txtanggal.getText(), selectedRow, 3);
                jTable1.setValueAt(cmbulan.getSelectedItem().toString(), selectedRow, 4);
            }
        } else {
            JOptionPane.showMessageDialog(null, "Tidak ada data dengan Keterangan tersebut");
        }
    }
} catch (Exception e) {
...
kosong();
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        ...
        String sql = "DELETE FROM pengeluaran WHERE jenis = ?";
        java.sql.Connection conn = (java.sql.Connection) Config.getConnection();
        java.sql.PreparedStatement pst = conn.prepareStatement(sql);
        ...
        if (rowsAffected > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Tidak ada data dengan keterangan tersebut");
        }
    }
} catch (Exception e) {
...
String bulan = cmbulan.getSelectedItem().toString();
...
try {
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        ...
        // Add quotes around jumlah and harga
        statement.executeUpdate("INSERT INTO pengeluaran VALUES ('" + jenis + "','" + keterangan + "','" + harga + "','" + tanggal + "','" + bulan + "');");
        statement.close();
...
kosong();
    ...
    private void Jlabelll4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Jlabelll4MouseClicked
        try {
            String reportPath = "src\\Cetak\\report1.jasper";
