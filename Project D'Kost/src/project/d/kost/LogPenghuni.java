...
public class LogPenghuni extends javax.swing.JFrame {
 private Color ClickedColor;
    ...
    public void datatable() {
        try {
            ...
            tbl.addColumn("Nama");
            tbl.addColumn("Nohp_penghuni");
            tbl.addColumn("Waktu");

            jTable1.setModel(tbl);

            try (
                    Statement statement = Config.getConnection().createStatement(); ResultSet res = statement.executeQuery("SELECT * FROM Log_Penghuni")) {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("History Penghuni");
        pn_kanan.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, 240, -1));
        ...
        pn_kanan.add(txt_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, 114, 28));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIK", "Kode Kamar", "Nama", "NoHp Penghuni", "Waktu"
            }
        ));
        ...
        pn_kanan.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 572, 280));
        ...
        pn_kanan.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 110, 37, 30));

        jLabel16.setBackground(new java.awt.Color(0, 0, 0));
        jLabel16.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Cari Data");
        pn_kanan.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 110, -1, -1));

        jLabel18.setBackground(new java.awt.Color(0, 0, 0));
        jLabel18.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel18.setText("Cari Data");
        pn_kanan.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 110, -1, -1));
        ...
        Jlabelll1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/refresh.png"))); // NOI18N
        Jlabelll1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll1MouseClicked(evt);
            }
        });
        pn_kanan.add(Jlabelll1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 80, 28));

        Jlabelll2.setFont(new java.awt.Font("Futura Bk BT", 0, 18)); // NOI18N
        Jlabelll2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/kembali 1.png"))); // NOI18N
        Jlabelll2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll2MouseClicked(evt);
            }
        });
        pn_kanan.add(Jlabelll2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 80, 28));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogPenghuni.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
