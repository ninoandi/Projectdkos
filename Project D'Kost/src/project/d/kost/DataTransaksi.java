...
public class DataTransaksi extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(324, 35, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Kamar", "Nama", "Harga", "Sewa", "Total Bayar", "Masuk", "Keluar", "Tanggungan", "Status"
            }
        ));
        ...
        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 160, 770, 283));
        ...
        jPanel2.add(txt_cari, new org.netbeans.lib.awtextra.AbsoluteConstraints(585, 109, 133, 27));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 100, 37, 36));
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, -1, 76));
        ...
        jPanel2.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 419, -1, -1));
        ...
        jPanel2.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 419, -1, -1));
        ...
        jPanel2.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 0, 110, 76));

        jLabel9.setBackground(new java.awt.Color(0, 0, 0));
        jLabel9.setFont(new java.awt.Font("Futura Md BT", 0, 14)); // NOI18N
        jLabel9.setText("Cari Data");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(506, 114, -1, -1));
        ...
        Jlabelll3.setText("Hapus");
        Jlabelll3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll3MouseClicked(evt);
            }
        });
        jPanel2.add(Jlabelll3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 80, -1));
        ...
        Jlabelll2.setText("Update");
        Jlabelll2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll2MouseClicked(evt);
            }
        });
        jPanel2.add(Jlabelll2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 80, -1));
        ...
        Jlabelll1.setText("Tambah");
        Jlabelll1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Jlabelll1MouseClicked(evt);
            }
        });
        jPanel2.add(Jlabelll1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 80, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/print1.png"))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 0, -1, 500));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/logo dkost.png"))); // NOI18N
   ...
   try {
    ...
    int selectedRow = jTable1.getSelectedRow();
    if (selectedRow == -1) {
        JOptionPane.showMessageDialog(null, "Silakan pilih baris yang ingin dicetak.");
        return;
    }

    HashMap<String, Object> parameter = new HashMap<>();
    parameter.put("Kdkamar", txt_cari.getText());

    String reportPath = "src/Cetak/report2.jrxml"; 
    ...
    ex.printStackTrace();
    JOptionPane.showMessageDialog(null, "Terjadi kesalahan saat membuat laporan: " + ex.getMessage());
}
